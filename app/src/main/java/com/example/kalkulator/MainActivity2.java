        ...
        btnPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((txtAngka1.getText().length() > 0) & (txtAngka2.getText().length() > 0)) {
                    ...
                    Toast toast = Toast.makeText(MainActivity2.this, "Masukkan Angka 1 dan 2", Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
        });
        ...
        btnMines.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((txtAngka1.getText().length() > 0) & (txtAngka2.getText().length() > 0)) {
                   ...
                   double Angka2 = Integer.parseInt(txtAngka2.getText().toString());
                   double hasil = Angka1 - Angka2;
                    Toast.makeText(MainActivity2.this, "Hasil : " + hasil, Toast.LENGTH_SHORT).show();
                } else {
                    Toast toast = Toast.makeText(MainActivity2.this, "Masukkan Angka 1 dan 2", Toast.LENGTH_SHORT);
                    toast.show();
                }
